  ...
  create or replace view `irish-market-intelligence`.`FINANCIAL_MARKETS`.`int_daily_returns`
  OPTIONS()
  as -- int_daily_returns: calculate daily and cumulative returns per ticker.
--
