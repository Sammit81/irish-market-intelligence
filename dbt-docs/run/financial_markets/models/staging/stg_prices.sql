  ...
  create or replace view `irish-market-intelligence`.`FINANCIAL_MARKETS`.`stg_prices`
  OPTIONS()
  as -- stg_prices: clean and type-cast the raw price data.
--
...
FROM `irish-market-intelligence`.`FINANCIAL_MARKETS`.`RAW_PRICES`
