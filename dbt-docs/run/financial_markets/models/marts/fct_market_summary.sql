...
create or replace transient table FINANCIAL_MARKETS.PUBLIC.fct_market_summary
    
    
    
    as (-- fct_market_summary: one row per ticker with latest price and key metrics.
